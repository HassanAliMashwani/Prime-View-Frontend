...
export default function EventsAndMediaPage() {
  return (
    <div className="bg-pure-white text-charcoal min-h-screen">
      ...
      {/* Light Header Banner */}
      <div className="bg-[#F4F1EA] text-charcoal pt-32 sm:pt-36 pb-12 px-6 sm:px-8 lg:px-12 text-center border-b border-card-border relative overflow-hidden w-full">
      ...
      <div className="py-20 bg-soft-white border-b border-card-border/60">
