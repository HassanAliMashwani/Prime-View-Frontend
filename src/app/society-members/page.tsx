    ...
    <div className="bg-pure-white text-charcoal min-h-screen pt-28 sm:pt-32 pb-16">
      <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 space-y-10">
        ...
        <div className="bg-soft-white rounded-2xl border border-card-border p-6 sm:p-8 space-y-6 shadow-xs">
          {/* Search Section */}
          <div className="bg-green-tint-bg/60 p-4 sm:p-5 rounded-xl border border-accent-green/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <label
            ...
            <div className="relative w-full sm:w-80">
              <Search className="w-4 h-4 text-muted-gray-text absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                id="member-search"
                type="text"
                value={searchTerm}
                ...
                className="w-full pl-9 pr-3 py-2.5 text-xs border border-card-border rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-green bg-pure-white shadow-xs text-charcoal placeholder-muted-gray-text"
              />
            </div>
          </div>
          ...
          <div className="space-y-4 pt-2">
            <h3 className="font-display text-lg font-semibold text-charcoal border-b border-card-border pb-2">
            ...
            {filteredCriteria.length > 0 ? (
              <ul className="space-y-3">
                {filteredCriteria.map((item, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 bg-pure-white p-4 rounded-xl border border-card-border shadow-xs"
                  >
              ...
              <p className="text-xs text-muted-gray-text py-6 text-center">
        ...
        <div className="bg-soft-white rounded-2xl border border-card-border p-5 text-xs text-muted-gray-text space-y-1">
