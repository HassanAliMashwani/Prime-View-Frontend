  ...
  return (
    <div className="bg-pure-white min-h-screen py-16 px-4 sm:px-6 lg:px-8 text-charcoal">
      <div className="max-w-5xl mx-auto space-y-12">
        {/* Styleguide Header */}
        <div className="border-b border-stone pb-6 text-center space-y-2">
          <span className="text-xs font-bold uppercase tracking-widest text-verified-green bg-soft-white px-3 py-1 rounded-full border border-verified-green/20">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-display text-charcoal border-b border-stone pb-2">
            1. Rev. 3 Color System (White Dominant, Beige Support, Green Accent)
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-pure-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-pure-white border border-stone" />
              <div className="text-xs font-mono font-bold">Pure White</div>
              <div className="text-[10px] text-charcoal/60">#FFFFFF (65–75% Dominant)</div>
            </div>
            <div className="bg-soft-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-soft-white border border-stone" />
              <div className="text-xs font-mono font-bold">Soft White</div>
              <div className="text-[10px] text-charcoal/60">#FAF9F7 (Soft Surfaces)</div>
            </div>
            <div className="bg-warm-beige p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-warm-beige" />
              <div className="text-xs font-mono font-bold">Warm Beige</div>
              <div className="text-[10px] text-charcoal/60">#EFE7DA (20–30% Support)</div>
            </div>
            <div className="bg-deep-beige p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-deep-beige" />
              <div className="text-xs font-mono font-bold">Deep Beige</div>
              <div className="text-[10px] text-charcoal/60">#E2D6C3 (Section Contrast)</div>
            </div>
            <div className="bg-verified-green text-pure-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-verified-green" />
              <div className="text-xs font-mono font-bold">Accent Green</div>
              <div className="text-[10px] text-emerald-100">#137547 (5–10% CTAs &amp; Chips)</div>
            </div>
            <div className="bg-soft-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
              <div className="w-full h-16 rounded-lg bg-soft-white border border-verified-green/20" />
              <div className="text-xs font-mono font-bold">Green Tint BG</div>
              <div className="text-[10px] text-verified-green">#EEF5F1 (Chip/Badge Fill)</div>
            </div>
            <div className="bg-charcoal text-pure-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
            ...
            <div className="bg-deep-forest text-pure-white p-4 rounded-xl border border-stone space-y-2 shadow-xs">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6 bg-soft-white p-6 rounded-2xl border border-stone">
            <div>
              <span className="text-[10px] font-mono uppercase text-verified-green block mb-1">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-display italic text-charcoal/60">
