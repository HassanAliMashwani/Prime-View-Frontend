...
export const pagesData: Record<string, PageMeta> = {
  ...
  owners: {
    title: "Managing Committee & Owners - Prime View Housing Society",
    description: "Managing Committee and leadership details.",
    h1: "Managing Committee & Owners",
  },
  "society-members": {
    title: "Society Members - Prime View Housing Society",
    description: "Information for registered society members and allottees.",
    h1: "Society Members Portal & Info",
  },
  "legal-team": {
    title: "Legal Team - Prime View Housing Society",
    description: "Legal team and compliance disclosures.",
    h1: "Legal Advisory Team",
  },
  "marketing-sales-partner": {
    title: "Marketing & Sales Partner - Prime View Housing Society",
    description: "Exclusive marketing and booking partners.",
    h1: "Marketing & Sales Partner Office",
  },
};
