...
export const GalleryNav: React.FC = () => {
  ...
  return (
    <header className="sticky top-20 z-40 w-full bg-pure-white border-b border-stone/60 shadow-sm mt-4">
      <div className="flex items-center justify-between px-4 sm:px-6 h-14 max-w-[1600px] mx-auto">
          ...
          <button
            ...
            className={`text-[15px] font-sans font-medium transition-colors pb-1 border-b-2 ${
              activeTab === "following"
                ...
                : "text-charcoal/60 border-transparent hover:text-charcoal/70"
            }`}
          >
            Following
          </button>
        ...
        <div className="flex-1 flex justify-end">
          <button className="text-charcoal/60 hover:text-charcoal transition-colors p-2 rounded-full focus-visible:outline focus-visible:outline-2 focus-visible:outline-charcoal">
